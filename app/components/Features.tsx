        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={index}
              variants={item}
              className="group relative overflow-hidden rounded-2xl border border-gray-800/50 bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10"
            >
