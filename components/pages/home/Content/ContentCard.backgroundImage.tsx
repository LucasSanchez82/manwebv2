...
const ContentCardBackgroundImage: React.FC<BackgroundImageProps> = ({
  imageUrl,
  maxRetries = 3,
  retryDelay = 1000,
}) => {
  ...
  return (
    <div className="absolute inset-0">
      ...
      {error && (
        <div className="absolute bottom-0 left-0 right-0 bg-red-500 bg-opacity-75 p-1 text-center text-xs text-white">
          {error}
        </div>
      )}
    </div>
...
export default ContentCardBackgroundImage
